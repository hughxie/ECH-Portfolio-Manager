...
const STOCKS: Stock[] = [
  {id: 1, fullName: 'Google', symbol: 'GOOG', currentPrice: 625, netPercent: 2.34, netChange: 7.95},
  {id: 2, fullName: 'Apple', symbol: 'AAPL', currentPrice: 123, netPercent: 1.33, netChange: 6.51},
  {id: 3, fullName: 'Shopify', symbol: 'SHOP', currentPrice: 93, netPercent: 4.6, netChange: 9.3},
